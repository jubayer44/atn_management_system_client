...
const TimeSheet = () => {
  ...
  const [searchTerm, setSearchTerm] = useState(customInput);
  ...
  // console.log("Selected Date: ", format(selectedDate, "dd/MM/yyyy")); // Logs the date in 'dd/MM/yyyy' format

  const searchParams = {
    ...(searchTerm ? { searchTerm } : {}),
    ...(!isModalOpen && customInput ? { searchTerm: customInput } : {}),
    ...(!isModalOpen && selectedRole ? { role: selectedRole } : {}),
    ...(!isModalOpen && sortBy ? { sortBy } : {}),
    sortOrder,
    page: currentPage,
    limit: itemsPerPage,
  };
